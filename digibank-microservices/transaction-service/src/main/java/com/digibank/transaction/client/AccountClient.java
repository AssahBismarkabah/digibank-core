...
public class AccountClient {
    ...
    public AccountClient(RestClient.Builder builder, @Value("${clients.account-service-url:http://localhost:8082}") String baseUrl) { this.client = builder.baseUrl(baseUrl).build(); }
