...
story += [P("5.4 ZAP alert summary", "H2Black"), P("The ZAP summary reports zero High alerts, one Medium alert, zero Low alerts and zero Informational alerts. The remaining Medium alert is the local plain-HTTP warning associated with HTTP Basic authentication. It is recorded and explained in the report."), Image(str(ZAP_ALERTS), width=175 * mm, height=87 * mm), PageBreak()]
